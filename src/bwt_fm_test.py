...
def main():
    ...
    test_cases = [
        ...
        {
            "bwt_fm": bfo.BwtFmOptimized("ABRACADABRA", 2, 2),
            "_suffix_array": [11, 7, 3, 8, 4, 9],
            "_bwt": "ARD$RCAAAABB",
            "_counts_per_char": {'A': 5, 'B': 2, 'C': 1, 'D': 1, 'R': 2, '$': 1},
            "_first_column": {'A': (1, 6), 'B': (6, 8), 'C': (8, 9), 'D': (9, 10), 'R': (10, 12), '$': (0, 1)},
            "_tally": {'A': [1, 1, 1, 2, 4, 5], 'B': [0, 0, 0, 0, 0, 1], 'C': [0, 0, 0, 1, 1, 1], 'D': [0, 1, 1, 1, 1, 1], 'R': [0, 1, 2, 2, 2, 2]},
        }
    ]
